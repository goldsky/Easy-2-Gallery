...
if (file_exists('../assets/modules/easy2/install/langs/'.$modx->config['manager_language'].'.inc.php')) {
    ...
    // include '../assets/modules/easy2/install/langs/russian.inc.php'; // goldsky -- use english as default
...
PRIMARY KEY  (id)
    ...
    $mod = 'include_once MODX_BASE_PATH . \'assets/modules/easy2/module.easy2gallery.php\';';
