...
<p><?php echo $lng['comments']; ?> <?php echo $lng['files']; ?>: <?php echo $gdir; ?> <b><a href="javascript:imPreview5('<?php echo $gdir . $row['filename']; ?>');void(0);"><?php echo $row['filename']; ?></a></b> (<?php echo $row['comments']; ?>)
    &nbsp; &nbsp; &nbsp;
    <img src="<?php echo E2G_MODULE_URL; ?>includes/tpl/icons/arrow_refresh.png" width="16" height="16" border="0" alt="" />
    <a href="<?php echo $index; ?>&amp;page=comments&amp;file_id=<?php echo $_GET['file_id']; ?>&amp;pid=<?php echo $parentId; ?>"><?php echo $lng['update']; ?></a>
    &nbsp; &nbsp; &nbsp;
    <a href="<?php echo $index; ?>&amp;pid=<?php echo $parentId; ?>"><?php echo $lng['back']; ?></a>
</p>
<div class="imPreview" id="pElt5" style="display:none;" ></div>
