...
$e2gsnip_cfg['where_dir'] = isset($where_dir) ? $where_dir : NULL;
$e2gsnip_cfg['where_file'] = isset($where_file) ? $where_file : NULL;
...
if ($e2gsnip_cfg['showonly'] == 'dirs')
    $e2gsnip_cfg['showonly'] = 'folders';
...
if (isset($e2gsnip_cfg['static_gid']))
    $group_suffix = $modx->stripAlias($e2gsnip_cfg['static_gid']);
elseif (isset($e2gsnip_cfg['static_tag']))
    $group_suffix = $modx->stripAlias($e2gsnip_cfg['static_tag']);
else
 ...
 */
$e2gsnip_cfg['nav_prevUpNext'] = ( isset($nav_prevUpNext) && is_numeric($nav_prevUpNext) ) ? $nav_prevUpNext : $e2g['nav_prevUpNext'];
$e2gsnip_cfg['nav_prevSymbol'] = ( isset($nav_prevSymbol) ) ? $nav_prevSymbol : $e2g['nav_prevSymbol'];
$e2gsnip_cfg['nav_upSymbol'] = ( isset($nav_upSymbol) ) ? $nav_upSymbol : $e2g['nav_upSymbol'];
$e2gsnip_cfg['nav_nextSymbol'] = ( isset($nav_nextSymbol) ) ? $nav_nextSymbol : $e2g['nav_nextSymbol'];
