...
//http://spaceforaname.com/galleryview
    ...
    if (!isset($ss_config)) $ss_config='gallerylight';
    ...
    if (!empty($ss_css)) {
        ...
        $modx->regClientCSS(E2G_SNIPPET_URL.'slideshows/galleryview/galleryview.css','screen');
    }
    if ($ss_config=='polaroid') {
        $modx->regClientCSS(E2G_SNIPPET_URL.'slideshows/galleryview/themes/polaroid/polaroid.css','screen');
    }
    if (empty($ss_css)) {
    ...
    $modx->regClientStartupScript(E2G_SNIPPET_URL.'slideshows/galleryview/jquery.easing.1.3.js');
    $modx->regClientStartupScript(E2G_SNIPPET_URL.'slideshows/galleryview/jquery.galleryview-1.1.js');
    $modx->regClientStartupScript(E2G_SNIPPET_URL.'slideshows/galleryview/jquery.timers-1.1.2.js');
    $modx->regClientStartupHTMLBlock('
