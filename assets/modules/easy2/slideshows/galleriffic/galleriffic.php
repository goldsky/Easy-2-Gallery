...
//    $modx->regClientCSS(E2G_SNIPPET_URL.'slideshows/galleriffic/css/basic.css');
    if ($ss_config=='example-1') {
        if (!empty($ss_css)) {
            $modx->regClientCSS($ss_css,'screen');
        } else {
            $modx->regClientCSS(E2G_SNIPPET_URL.'slideshows/galleriffic/css/galleriffic-1.css','screen');
        }
    }
    if ($ss_config=='example-2') {
        if (!empty($ss_css)) {
            ...
            $modx->regClientCSS(E2G_SNIPPET_URL.'slideshows/galleriffic/css/galleriffic-2.css','screen');
        }
    }
    if ($ss_config=='example-3') {
        if (!empty($ss_css)) {
            ...
            $modx->regClientCSS(E2G_SNIPPET_URL.'slideshows/galleriffic/css/galleriffic-3.css','screen');
        }
    }
    if ($ss_config=='example-5') {
        if (!empty($ss_css)) {
            ...
            $modx->regClientCSS(E2G_SNIPPET_URL.'slideshows/galleriffic/css/galleriffic-5.css','screen');
//            $modx->regClientCSS(E2G_SNIPPET_URL.'slideshows/galleriffic/css/white.css','screen');
            $modx->regClientCSS(E2G_SNIPPET_URL.'slideshows/galleriffic/css/black.css','screen');
        }
    }
    ...
    if ($ss_config=='example-1') {
        if (!empty($ss_js)) {
            ...
            $modx->regClientStartupScript(E2G_SNIPPET_URL.'slideshows/galleriffic/js/galleriffic-1.js');
        }
    }
    if ( $ss_config=='example-2' ) {
        if (!empty($ss_js)) {
            ...
            $modx->regClientStartupScript(E2G_SNIPPET_URL.'slideshows/galleriffic/js/galleriffic-2.js');
        }
    }
    if ( $ss_config=='example-3' ) {
        if (!empty($ss_js)) {
            ...
            $modx->regClientStartupScript(E2G_SNIPPET_URL.'slideshows/galleriffic/js/galleriffic-3.js');
        }
    }
    if ( $ss_config=='example-5' ) {
        if (!empty($ss_js)) {
            ...
            $modx->regClientStartupScript(E2G_SNIPPET_URL.'slideshows/galleriffic/js/galleriffic-5.js');
        }
    }
